...
def draw_piano(whites, blacks):
    ...
    skip_count = 0 #checks how many spaces skipped
    last_skip = 2  
    skip_track = 2  #how many keys since last skipped
    black_rects = []
    ...
    for i in range(len(whites)): #green outline to indicate they are being played
        if whites[i][1] > 0:
            j = whites[i][0]
